...
namespace System.IO.Pipelines.Networking.Tls.Managed.Internal.BulkCiphers.Unix
{
    internal class UnixBulkCipherPal : IBulkCipherPal
    {
        ...
        {
            _providers[(int)BulkCipherType.AES_128_GCM] = new BulkCipherProvider(EVP_aes_128_gcm(),true);
            _providers[(int)BulkCipherType.AES_256_GCM] = new BulkCipherProvider(EVP_aes_256_gcm(), true);
        }
