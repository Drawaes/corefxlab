...
namespace System.IO.Pipelines.Networking.Tls.Managed.Internal.Windows
{
    internal static class BCryptPropertiesHelper
    {
        ...
        internal static void SetBlockChainingMode(SafeBCryptHandle provider, BulkCipherChainingMode chainingMode)
        {
            string value;
            switch (chainingMode)
            {
            ...
            SetStringProperty(provider, BCryptPropertyStrings.BCRYPT_CHAINING_MODE, value);
        }
    }
}
