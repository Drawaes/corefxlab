...
internal static partial class Interop
{
    internal static partial class NCrypt
    {
        ...
        [DllImport(Interop.Libraries.NCrypt, CharSet = CharSet.Unicode)]
        internal static extern unsafe ErrorCode NCryptSignHash(SafeNCryptKeyHandle hKey, void* pPaddingInfo, void* pbHashValue, int cbHashValue, void* pbSignature, int cbSignature, out int pcbResult, AsymmetricPaddingMode dwFlags);
