...
namespace System.IO.Pipelines.Networking.Tls.Managed.Handshake
{
    public class HandshakeServerCertificateWriter : IMessageWriter
    {
        ...
        {
            BufferExtensions.Write24BitNumber(context.SecurityContext.Certificate.RawData.Length + 3, ref buffer);
            BufferExtensions.Write24BitNumber(context.SecurityContext.Certificate.RawData.Length, ref buffer);
